    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <Calendar
          ...
          firstDay={1}
          markedDates={{
            '2018-09-14': {selected: true, marked: true},
            '2018-09-15': {selected: true, marked: true, dotColor: 'green'},
            '2018-09-16': {marked: true, dotColor: 'red'},
            '2018-09-17': {marked: true},
            '2018-09-18': {disabled: true, activeOpacity: 0}
          }}
